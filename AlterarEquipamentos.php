        ...
        <form role="form" method="post" action="FunctionsEquipamentos.php?escolha=alterar&id= <?php echo $alterar_id?>">
            <div class="row col-md-12">
                <div class="form-group col-md-12">
                    ...
                    <input type="varchar" class="form-control" id="InputEquipamentos" name="InputEquipamentos" value="<?php echo $alterar_Equipamentos ?>" >
                </div>
            </div>
            <div class="row col-md-12">
                <div class="form-group col-md-12">
                    <label for="InputFuncao">Função</label>
                    <input type="varchar" class="form-control" id="InputFuncao" name="InputFuncao" value="<?php echo $alterar_Funcao ?>">
                </div>
            </div>
            <div class="row col-md-12">
                <div class="form-group col-md-12">
