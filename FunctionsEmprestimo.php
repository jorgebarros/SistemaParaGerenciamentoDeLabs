...
$record_Peca = $_POST['DropDownPeca'];


if ($_GET['escolha'] == "inserir") {
    $record = mysqli_query($db,"INSERT INTO tb_emprestimos(NomeResponsavel, DataRetirada, DataEntrega, Motivo, emprestimoPeca)
                                       value ('$record_NomeResponsavel','$record_DataRetirada','$record_DataEntrega',
                                              '$record_Motivo', '$record_Peca')");
